...
output_file_name_with_ext = st.text_input("Please give a name for the " +
                                          "decrypted file. Include extention)")
output_path = st.text_input("Please enter file path where you want " +
                            "your decrypted file." +
                            " If left blank, the file will be saved " +
                            "in an output folder.")

if st.button("Decrypt a file", key="file_encrypt_submit"):
    result, output_file_path = decrypt_file(file_path if upload_or_path ==
                                            "Enter a file path" else
                                            bytes_data,
                                            key_id,
    ...
    if result == "decryption ok":
        st.success("Your file has been decrypted successfully! " +
